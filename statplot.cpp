...
StatPlot::StatPlot(QWidget *parent)
    : QWidget{parent},path(QPointF(0,25))
{samples.push_back(std::make_pair(0,0));path.moveTo(0,25);}
...
void StatPlot::path_advance(unsigned long long timestamp,unsigned long long bps){
...
QPointF StatPlot::calc(unsigned long long ts,unsigned long long bps,unsigned long long ubound){
